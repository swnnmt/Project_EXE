              ...
              <div className="row">
                <div className="col-md-6">
                 ...
                 <div className="col-md-6">
                    <div className="contact-info-item">
                        ...
                        <h5>Fan page</h5>
                        <div className="text">
                            <i className="fab fa-facebook"></i> <a href="https://www.facebook.com/groups/966715394202687" target="_blank" rel="noopener noreferrer">facebook.com/groups</a>
                        </div>
                        </div>
                    </div>
                    </div>
                <div className="col-md-6">
                  <div className="contact-info-item">
                    ...
                    <div className="content">
                      <h5>Đại Học FPT</h5>
                      <div className="text">
                        <i className="fal fa-map-marker-alt"></i> Thạch Thất, Hòa Lạc, Hà Nội
                      </div>
                    </div>
                  </div>
                </div>
               <div className="col-md-6">
                    <div className="contact-info-item">
                        ...
                        <h5>Liên hệ Zalo</h5>
                        <div className="text">
                            <i className="fal fa-phone"></i> <a href="https://zalo.me/0901234567" target="_blank" rel="noopener noreferrer">0901 234 567</a>
                        </div>
                        </div>
                    </div>
                    </div>
